namespace _440DocumentManagement.Models
{
	public class DLProject : BaseModel
	{
		...
		public string project_award_datetime { get; set; }
		public string project_complete_datetime { get; set; }
		public string project_contract_datetime { get; set; }
		public string project_expected_award_datetime { get; set; }
		public string project_expected_contract_datetime { get; set; }
		public string project_prebid_mtg_datetime { get; set; }
		public string project_start_datetime { get; set; }
		public string project_work_end_datetime { get; set; }
		public string project_work_start_datetime { get; set; }
