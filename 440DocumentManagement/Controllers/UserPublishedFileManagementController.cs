            ...
            try
            {
                ...
                using (var cmd = _dbHelper.SpawnCommand())
                {
                    ...
                    cmd.CommandText = "SELECT folder_transaction_log.doc_id, project_documents.doc_name, project_documents.doc_number, "
                        ...
                        + "project_documents.doc_subproject, project_documents.doc_pagenumber "
                    ...
                    result.ForEach(dict =>
                    {
                        ...
                        {
                            dict["file_name"] = __getFileName(
                                dict["doc_name"] as string,
                                dict["doc_number"] as string,
                                dict["doc_subproject"] as string,
                                dict["doc_pagenumber"] as string,
                                dict["doc_revision"] as string,
                                dict["original_filename"] as string,
                                dict["project_id"] as string,
                                dict["file_type"] as string);
                        }
                        else
                        {
...
*/
        ...
        private string __getFileName(
                        string doc_name,
                        string doc_number,
                        string doc_subproject,
                        string doc_pagenumber,
                        string doc_revision,
                        ...
                        string file_type)
        {
            ...
            if (!string.IsNullOrEmpty(doc_subproject))
            {
                doc_number = doc_subproject + "_" + doc_number;
            }
            if (!string.IsNullOrEmpty(doc_pagenumber))
            {
                doc_number = doc_number + "_" + doc_pagenumber;
            }
